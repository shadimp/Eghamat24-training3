...
<body style="direction:rtl ;">
    <h3>سفارشات تایید شده در انتظار پرداخت مشتری</h3>
    <table border="1" class="mytable">
        ...
        <tbody>
            ...
            where order_register.confirm_state='1' and order_register.payment_state='0'and order_register.seller_id='$seller_id';
            ");
